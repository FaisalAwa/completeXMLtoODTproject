...
with st.sidebar:
    ...
    st.markdown("""
    Please refer to this document for proper ODT processing format:
    
    [ODT Processing Guide](https://docs.google.com/document/d/1DtcAg-yTgmjd8B0uGOm0zBwOxEPmKD-lJvOYiozG5y8/edit?usp=sharing)
    """)
    st.markdown("---")
